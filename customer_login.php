		...
		<div class="circle-w3layouts"></div>
			...
			<form action="abc.php" method="post">
								<div class="inputs-w3ls">
									...
									<input type="text" name="invno" placeholder="Username" required=""/>
								</div>
								<div class="inputs-w3ls">
									<i class="fa fa-key" aria-hidden="true"></i>
									<input type="password" name="invno" placeholder="Password" required=""/>
								</div>
								...
								<?php
if (isset($_POST['s3'])){
	$username=$_POST['invno'];
	$password=$_POST['invno'];
	
    
include "config.php";

$select= "select * from sales where invno='$username' and invno='$password' 
";
